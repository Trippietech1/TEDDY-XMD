...
malvin({
    ...
    try {
        ...
        const { data: commitData } = await axios.get("https://api.github.com/repos/Teddytech1/TEDDY-XMD/commits/main");
        ...
        if (latestCommitHash === currentHash) {
            return reply("✅ Your TEDDY-XMD bot is already up-to-date!");
        }
