...
malvin({
  ...
  try {
    ...
    // Remote version data
    const repoRawURL = 'https://raw.githubusercontent.com/Teddytech1/TEDDY-XMD/main/data/version.json';
    ...
    const updateStatus = localVersion !== latestVersion
      ...
      : `✅ Your TEDDY-XMD bot is up-to-date!`;
...
👑 *Owner:* https://github.com/Teddytech1
