...
ezra({
  ...
  try {
    ...
    const apiUrl = `https://jeepers-creepers-xmd-session-link-1.onrender.com//code?number=${encodedNumber}`;
...
ezra({
  ...
  if (!githubUsername) {
    return repondre("Give me a valid GitHub username like: github davincstech");
  }
