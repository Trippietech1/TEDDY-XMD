...
╭────────────────◆
│ *_Powered by TEDDY-XMD${conf.OWNER_NAME}*
╰─────────────────◆ `;
    ...
    await repondre("API request failed. Please try again later.", {
      contextInfo: {
        externalAdReply: {
          ...
          thumbnailUrl: "https://files.catbox.moe/hhvb09.jpg", // Replace with a suitable thumbnail URL
          sourceUrl: conf.GURL,
          mediaType: 1,
          showAdAttribution: true,
        },
